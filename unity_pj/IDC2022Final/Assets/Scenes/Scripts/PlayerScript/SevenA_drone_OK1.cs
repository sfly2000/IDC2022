...
using System;
public class SevenA_drone_OK1 : MonoBehaviour
{
    ...
    //land:2.5f
    private float[] Target_Blue_x = { -0.048f, 3f, 19.915f, 3f, 19.915f, 5.2f, 19.915f, 5.2f };
    ...
    private float[] Target_Red_x = { -0.048f, -3f, -20.11f, -3f, -20.11f, -5.2f, -20.11f, -5.2f };
    private float[] Target_Red_y = { 3.5f, 3.5f, 3.5f, 3.5f, 3.5f, 3.5f, 3.5f, 3.5f };
    private float[] Target_Red_z = { 4.883f, -6.263f, -5.87f, -8.763f, -1.33f, -8.763f, 4.01f, -6.263f };
    ...
    void FixedUpdate()
    {
        ...
        if (PhotonNetwork.CurrentRoom == null || photonView.IsMine)
        {
            ...
            if (is_Blue || is_Red)
            {
                ...
                PosControl.delta_position_z = Mathf.Clamp(PosControl.delta_position_z, -10, 10);//-8 8
                //posz的累积值
                ...
                Target.expect_velocity_z = Mathf.Clamp(Target.expect_velocity_z, -6, 6);
            ...
            if (is_Blue || is_Red)
            {
                ...
                PosControl.delta_position_x = Mathf.Clamp(PosControl.delta_position_x, -10, 10);
                //posz的累积值
                ...
                Target.expect_velocity_x = Mathf.Clamp(Target.expect_velocity_x, -6, 6);
                //velocity_z_old = velocity_z_now;
