...
public class DroneCtrl_team02 : MonoBehaviour
{
    ...
    {
        public string InputKeyUpTo7 = "u";
        public string InputKeyturn90degree = "t";
        public string InputKeyUp = "q";
        public string InputKeyDown = "e";
        public string InputKeyForward = "w";
        public string InputKeyBackward = "s";
        public string InputKeyRight = "d";
        public string InputKeyLeft = "a";
        public string InputKeyTurnright = "k";
        public string InputKeyTurnleft = "j";
        public string InputKeyButtton = "r";
    }
...
//        public string InputKeyUpTo7;
//       public string InputKeyturn90degree;
            if (Input.GetKey(InputKey.InputKeyUpTo7))
            {
                HeightControl.set_height = 7f;
            }

            if (Input.GetKey(InputKey.InputKeyturn90degree))
            {
                HorizontalRotationControl.set_eular_y = 90f;
            }
            ...
            {
                HeightControl.set_height -= HeightControl.set_vy * Time.deltaTime;
                HeightControl.set_height = Mathf.Max(HeightControl.set_height, -0.9f);
            }
